...
How project works:
Most stock management systems revolve around CRUD operations:
- Create → Add new products to the inventory
- Read → Display product details (search by ID or name)
- Update → Modify quantity or price when stock changes
